...
/**
  ...
  Description: this task involves the following parameters: most commented, most recent, a to z, and z to a post  titles. there will be four buttons that when clicked on the posts will order based off those parameters. these buttons will go on the category archive page and author archive page and search archive page. When these buttons are clicked on, the posts will sort accordingly.
...
**/
	...
	add_filter('posts_where','himanshu_where');
...
$getValue=$wpdb->get_row( $wpdb->prepare( "select default_status from default_sorting_option" ), ARRAY_N);
...
<li><a href="?';
        ...
        add_menu_page( 'Sorting', 'Sorting', '', 'sorting/sorting-admin.php', '', plugins_url( 'sorting/img/search_16.png' ) );
